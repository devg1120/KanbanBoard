...
class Modal {
  ...
  onSave = () => {
    ...
    if (this.sticky) {
      ...
      const sticky_type_class = "sticky-type-" + modal.type;
      //this.target.querySelector(".sticky").className = "sticky " + sticky_type_class;
      this.target.className = "sticky " + sticky_type_class;

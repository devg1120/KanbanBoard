...
export default class Sticky {
  ...
  createSticky() {
    ...
    const sticky_type_class = "sticky-type-" + this.type;
    const sticky = createElementWithClasses("div", "sticky" , sticky_type_class );
    ...
    //GS if (this.column !== "done") sticky.setAttribute("draggable", "true");
    sticky.setAttribute("draggable", "true"); //GS
